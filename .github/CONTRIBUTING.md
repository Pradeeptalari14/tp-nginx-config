...
Thank you for your interest in improving the **Nginx Configurator** studio resources! 🎉
...
# 2. Clone your fork
git clone https://github.com/YOUR_USERNAME/tp-nginx-config.git
...
Generated configurations come from the **[Nginx Configurator Studio](https://pradeeptalari14.github.io/portfolio/tools/nginx-config/)**.
