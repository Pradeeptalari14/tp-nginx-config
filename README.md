...
[![Studio](https://img.shields.io/badge/Developer_Studio-Live-brightgreen)](https://pradeeptalari14.github.io/portfolio/tools/nginx-config/)
...
```
1. Open Studio → https://pradeeptalari14.github.io/portfolio/tools/nginx-config/
...
| Resource | Link |
|----------|------|
| Interactive Studio | [Open →](https://pradeeptalari14.github.io/portfolio/tools/nginx-config/) |
