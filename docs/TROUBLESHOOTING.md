# 🔧 Troubleshooting Guide — Nginx Configurator
...
2. **Check official documentation:**
   - [GitHub Issues for this repo](https://github.com/Pradeeptalari14/tp-nginx-config/issues)
   - [Studio FAQ](https://pradeeptalari14.github.io/portfolio/tools/nginx-config/)
